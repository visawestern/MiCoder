...
Источник: `MiCoder/Sources/Views/SidebarView.swift` (959 LOC). Ручная сверка
проводки: 2026-08-06; `swift test` — 1716/1716 PASS. Статус ✅ означает
проверенный кодовый маршрут и тесты; Finder и контекстное меню требуют
отдельного live-QA. Основные действия:
...
Все пункты ✅ вручную прослежены через `SidebarView` до `AppState` и сервисов
навигации/уведомлений и подтверждены повторным полным `swift test`.
Детали: [`12-chain-verification-2026-08-06.md`](12-chain-verification-2026-08-06.md).
