...
Ручная сверка проводки: 2026-08-06; `swift test` — 1716/1716 PASS. ✅ —
проверенный маршрут/автотесты; реальные GitHub, git remote и premium-потоки
требуют live-QA.
...
Все пункты ✅ вручную прослежены от Git-контролов до `AppState`/`GitRepository`
и статусного результата; полный `swift test` повторно прошёл. Детали:
